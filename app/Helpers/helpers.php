...
function country_dropdown($name = null, $class = null, $value = null){
      ...
      $select = '<select';
      if($name != null) $select .= ' name="' . $name . '" id="' . $name . '"';
      if($class != null) $select .= ' class="' . $class . '"';
      $select .= ">";
      foreach($countryList as $abbr => $name){
            if($abbr == $value || ($abbr == 'US' && $value == null))
                  $select .= '<option value="' . $abbr . '" selected>' . $name . '</option>';
            else
                  $select .= '<option value="' . $abbr . '">' . $name . '</option>';
      }
      $select .= "</select>";
